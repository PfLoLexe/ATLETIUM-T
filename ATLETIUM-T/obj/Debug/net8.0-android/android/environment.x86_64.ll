...
@dso_cache = dso_local local_unnamed_addr global [40 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.0_name, ; name: libDXSchedulerNative.so
		ptr null; void* handle (0x0)
	}, ; 11
	%struct.DSOCacheEntry {
...
@.env.7 = private unnamed_addr constant [37 x i8] c"f31f7cd4-105f-44c6-a815-0601dae34155\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [26 x i8] c"com.companyname.atletiumt\00", align 16

;DSOCacheEntry
@.DSOCacheEntry.0_name = private unnamed_addr constant [24 x i8] c"libDXSchedulerNative.so\00", align 16
